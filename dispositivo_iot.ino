...
float dolar, varDolar;
bool invalido = true; // armazenará se a requisição de cotação é inválida
int buttonState = 0;
String url = "https://economia.awesomeapi.com.br/last/USD-BRL,EUR-BRL,BTC-BRL"; // link para teste. Mudará de acordo com o site pronto
